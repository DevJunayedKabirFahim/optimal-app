    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="{{ route('dashboard') }}">
                <img src="{{asset('/')}}website/assets/images/icon/logo.png" class="header-brand-img desktop-logo" alt="logo">
                <img src="{{asset('/')}}website/assets/images/icon/logo.png" class="header-brand-img light-logo1"
                     alt="logo">
            </a>
            <!-- LOGO -->
