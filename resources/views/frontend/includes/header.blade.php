    ...
    <div class="container">
        <div class="row topBar-slider">
            ...
            <div class="item d-flex flex-row justify-content-center justify-content-md-center justify-content-sm-center col-12 col-sm-6 col-md-4 col-lg-4 text-uppercase center">
                <a href="#">Free Shipping On Order Over $100</a>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-3 align-self-center justify-content-start d-flex">
                ...
                <!--End Mobile Toggle-->
                <!--Logo-->
                <div class="logo"><a href="{{ route('home') }}"><img class="logo-img mh-100" src="{{asset('/')}}frontend/assets/images/logo-demo2.png" alt="Optimal Largest eCommerce Platform in Bangladesh" title="Optimal Largest eCommerce Platform in Bangladesh" width="140" /><span class="logo-txt d-none">Optimal</span></a></div>
                <!--End Logo-->
            </div>
                                                ...
                                                <div class="row mm-Banners">
                                                    <div class="col-md-12 col-lg-12 imageCol text-center">
                                                        <div class="menubox position-relative">
                                                            <a href="index-demo6.html" class="mb-0"><img class="blur-up lazyload" src="{{asset('/')}}frontend/assets/images/megamenu/megamenu-banner8.png" data-src="{{asset('/')}}frontend/assets/images/megamenu/megamenu-banner8.png" alt="image"/></a>
                                    ...
                                    <div class="megamenu style4">
                                        <div class="row">
                                            <div class="lvl-1 col-md-3 col-lg-3"><a href="#" class="site-nav lvl-1 menu-title">Category Page</a>
                                                <ul class="subLinks">
                                                    ...
                                                    <li class="lvl-2"><a href="#" class="site-nav lvl-2">Daily Necessaries</a></li>
                                                    <li class="lvl-2"><a href="#" class="site-nav lvl-2">Medicines</a></li>
                                                    <li class="lvl-2"><a href="#" class="site-nav lvl-2">Garden's Accessories</a></li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="row clear mt-4">
                                            <div class="col-md-3 col-lg-3">
                                                <a href="shop-left-sidebar.html"><img src="{{asset('/')}}frontend/assets/images/megamenu/megamenu-banner4-1.jpg" data-src="{{asset('/')}}frontend/assets/images/megamenu/megamenu-banner4-1.jpg" alt="image"/></a>
                                            </div>
                                            <div class="col-md-3 col-lg-3">
                                                <a href="shop-left-sidebar.html"><img src="{{asset('/')}}frontend/assets/images/megamenu/megamenu-banner4-2.jpg" data-src="{{asset('/')}}frontend/assets/images/megamenu/megamenu-banner4-2.jpg" alt="image"/></a>
                                            </div>
                                            <div class="col-md-3 col-lg-3">
                                                <a href="shop-left-sidebar.html"><img src="{{asset('/')}}frontend/assets/images/megamenu/megamenu-banner4-3.jpg" data-src="{{asset('/')}}frontend/assets/images/megamenu/megamenu-banner4-3.jpg" alt="image"/></a>
                                            </div>
                                            <div class="col-md-3 col-lg-3">
                                                <a href="shop-left-sidebar.html"><img src="{{asset('/')}}frontend/assets/images/megamenu/megamenu-banner4-4.jpg" data-src="{{asset('/')}}frontend/assets/images/megamenu/megamenu-banner4-4.jpg" alt="image"/></a>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="lvl-1 col-md-3 col-lg-3"><a href="#" class="site-nav lvl-1 menu-title">Top Brands</a>
                                                <div class="menu-brand-logo">
                                                    <a href="brands-style2.html"><img src="{{asset('/')}}frontend/assets/images/logo/brandlogo1.png" alt="image"/></a>
                                                    <a href="brands-style2.html"><img src="{{asset('/')}}frontend/assets/images/logo/brandlogo2.png" alt="image"/></a>
                                                    <a href="brands-style2.html"><img src="{{asset('/')}}frontend/assets/images/logo/brandlogo3.png" alt="image"/></a>
                                                </div>
                                                <div class="menu-brand-logo">
                                                    <a href="brands-style2.html"><img src="{{asset('/')}}frontend/assets/images/logo/brandlogo4.png" alt="image"/></a>
                                                    <a href="brands-style2.html"><img src="{{asset('/')}}frontend/assets/images/logo/brandlogo5.png" alt="image"/></a>
                                                    <a href="brands-style2.html"><img src="{{asset('/')}}frontend/assets/images/logo/brandlogo6.png" alt="image"/></a>
                                                </div>
                                            </div>
                                            <div class="lvl-1 col-md-3 col-lg-3 p-0">
                                                <a href="shop-left-sidebar.html"><img src="{{asset('/')}}frontend/assets/images/megamenu/megamenu-banner3.jpg" alt="image"/></a>
                                            </div>
                                        </div>
                                    </div>
                                </li>
