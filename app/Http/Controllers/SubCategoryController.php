...
class SubCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('message', 'Product Sub-Category info Created Successfully.');
    }
    ...
    public function update(Request $request, SubCategory $subCategory)
    {
        ...
        return redirect()->route('sub-category.index')->with('message', 'Subcategory info updated successfully.');
    }
    ...
    {
        SubCategory::deleteCategory($subCategory);
